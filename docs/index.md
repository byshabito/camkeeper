...
hero:
  ...
  tagline: "Save creator profiles across sites, organize them your way, and keep all data local in your browser."
  image:
    src: /icon-256.png
    alt: CamKeeper icon
  actions:
...
features:
  ...
  - title: Privacy first
    details: No account, no cloud sync, no telemetry, and no third-party tracking.
---
