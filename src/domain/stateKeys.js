...
export const DEBUG_LOGGING_STATE_KEY = "camkeeper_debug_logging_enabled_v1";
export const NOSTR_SYNC_NSEC_STATE_KEY = "camkeeper_nostr_sync_nsec_v1";
export const NOSTR_SYNC_SECRET_VAULT_STATE_KEY = "camkeeper_nostr_sync_secret_vault_v1";
